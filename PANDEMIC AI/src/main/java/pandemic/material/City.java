...
public class City implements Comparable<City> {
  ...
  public void initGameActions(Map<String, City> map, ArrayList<Desease> arrayList,
      List<PlayedCharacter> characterReserve) {
    ...
    for (Desease localDesease : arrayList) {
      ...
      /*
       * for(Set<CityCard> cardSet : combinationSet) { cureActionMap.get(localDesease).add(new
       * Cure(this, localDesease, cardSet)); }
       */
    }
